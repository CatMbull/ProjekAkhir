    ...
    <div className="w-4/6 h-4/6">
      <div className="m-2">
        <form onSubmit={handleSubmit}>
          <IndexInput type="text" htmlFor="name" placeholder="Username or password" name="name" id="name" className="bg-transparent border-2 border-sky-300 text-white" onChange={(e) => setEmail(e.target.value)} value={email}>
            Username or Email
          </IndexInput>
